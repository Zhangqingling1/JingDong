...
public class MyGouwucheAdapter extends BaseExpandableListAdapter {
    ...
    public MyGouwucheAdapter(Context context, List<Map<String, Object>> parentMapList, List<List<Map<String, Object>>> childMapList_list) {
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(context, "店铺名称：" + parentName, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(context, "商品店铺名称：" + goodsBean.getName(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void removeOneGood(int groupPosition, int childPosition) {
       ...
       if (childMapList!=null&&childMapList.size()>0){
             ...
             childMapList_list.remove(groupPosition);
        }
